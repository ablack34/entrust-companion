...
export const mockRecommendations: AccountRecommendation[] = [
  ...
  },
  {
    ...
    bestContact: {
      ...
      enrichmentAction: 'linkedin_search_recommended',
      linkedinSearchUrl: 'https://www.linkedin.com/sales/search/people?query=(companyName%3ABeta%20Holdings)AND(title%3AIT%20Director)',
    },
    reasoning:
  ...
  },
  {
    ...
    bestContact: {
      ...
      title: 'CISO (recommended target persona)',
      email: null,
      emailSource: 'none',
      source: 'none',
      discovery: 'not-found',
      discoveryNote: 'No Salesforce Account or Contact found for domain nordicsecure.se. Based on Nordic Secure Systems\' profile (3,200 employees, Technology sector, Certificate Lifecycle product fit) and your configured persona priorities, the highest-value target persona is a CISO. Use LinkedIn Sales Navigator to identify and retrieve the right contact.',
      enrichmentAction: 'linkedin_search_recommended',
      linkedinSearchUrl: 'https://www.linkedin.com/sales/search/people?query=(companyName%3ANordic%20Secure%20Systems)AND(title%3ACISO)',
    },
    reasoning:
      'Nordic Secure Systems is a mid-size technology company (3,200 employees, Stockholm) with Certificate Lifecycle as a product fit tag. Industry relevance is strong for PKI solutions in the Nordic technology sector. However, no Salesforce Account or Contact exists for this company — there is no CRM history with Entrust. The AI recommends targeting the CISO based on your configured persona priorities. Use the LinkedIn Sales Navigator link below to find and verify the right contact before outreach.',
    needsReview: false,
    reviewReason: null,
    status: 'pending',
  },
